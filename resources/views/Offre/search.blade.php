    ...
    <div class="container-flex boxsearch">
            <div class="row boxcontent">
                ...
                <div class="col-lg-7 col-md-6 col-sm-5 col-xs-8">
                    <h5><a href="#"><strong>{{ $value->offre_titre }}</strong></a></h5>
                ...
                <div class="heart col-lg-2 col-md-2 col-sm-2 col-xs-4">
                    ...
                    <a class="btn btn-info" href="{{ route('Offre.show',$value->entreprise_id) }}">Show</a>
                    <a class="btn btn-primary" href="{{ route('Offre.edit',$value->entreprise_id) }}">Edit</a>
