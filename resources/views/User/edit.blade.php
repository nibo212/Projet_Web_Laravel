         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="user_centre" value="{{ $User->user_centre }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>user role</strong>
                    <input type="text" name="user_role" value="{{ $User->user_role }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>promo id</strong>
                    <input type="text" name="promo_id" value="{{ $User->promo_id }}" class="form-control" placeholder="Title">
                </div>
            </div>
