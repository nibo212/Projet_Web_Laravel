    ...
    <main class="container-fluid"> <br><br>
        <div class="row">
            ...
            <div class="container-fluid annonce col-md-4">
                ...
                <p></p>
                <p class="para">
                    <strong>Ville :</strong> {{ $Entreprise->localite_ville}} <br>
                    <strong>CP :</strong> {{ $Entreprise->localite_cp}} <br>
                    <strong>Email:</strong> {{ $Entreprise->email}} <br>
                    <strong>Nombres de stagiaires embauchés:</strong> {{ $Entreprise->entreprise_nb_stagiaires}}<br>
                    <strong>Secteur d'acitivité :</strong> {{ $Entreprise->entreprise_secteur}} <br>
                </p>
                ...
                <form  action="{{ url('Entreprise/add/'.$Entreprise->entreprise_id ) }}">
                <input type="submit" href="" class="container-fluid postule btn btn-primary" value="Evaluer l'entreprise"></input>
                </br>
                </br>
                <label for="name">Evaluez {{$Entreprise->entreprise_nom}}:</label>
                <input type="textarea" id="name" name="name" minlength="4" maxlength="200" >
                </form>
            </div>
