...
<main class="container">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-6">
                <a class="btn btn-primary col-lg-12 col-md-12 col-sm-12" href="{{ route('Entreprise.create') }}"> Create New Post</a>
            </div>
    ...
    <div class="container-flex boxsearch">
            <div class="row boxcontent">
                ...
                <div class="col-lg-7 col-md-6 col-sm-5 col-xs-8">
                    <h5><a href="{{ route('Entreprise.show',$value->entreprise_id) }}"><strong>{{ $value->entreprise_nom }}</strong></a></h5>
